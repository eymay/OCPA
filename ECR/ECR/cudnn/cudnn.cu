#include <iostream> // remove it included in cudnn_util.h
#include <stdio.h>  // remove it included in cudnn_util.h
#include <stdlib.h> // remove it included in cudnn_util.h
#include <fstream>
#include <vector>  // remove it included in cudnn_util.h
#include <cstdlib> // remove it included in cudnn_util.h
#include <iomanip> // remove it included in cudnn_util.h
#include <cuda.h>  // remove it included in cudnn_util.h 
#include <cudnn.h> // remove it included in cudnn_util.h
#include "cuda_fp16.h"
